# HSK DMS Class reference document
The following document are separated from HSKTODO.MD at 2025-12. some info maybe outdated.
## Weapon class
Sort by Weapon Ammo, Size(dimension), And min interact requirements.
